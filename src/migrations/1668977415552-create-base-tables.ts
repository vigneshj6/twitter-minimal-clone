...
export class createBaseTables1668977415552 implements MigrationInterface {
    name = 'createBaseTables1668977415552'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "postById" integer, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "index_post_hash_tag_hash_tag" ON "post_hashtag" ("hashtagIdId") `);
        ...
        await queryRunner.query(`ALTER TABLE "post" ADD CONSTRAINT "FK_9fd8155f7438e12e8826dc2c6f9" FOREIGN KEY ("postById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "post" DROP CONSTRAINT "FK_9fd8155f7438e12e8826dc2c6f9"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."index_post_hash_tag_hash_tag"`);
